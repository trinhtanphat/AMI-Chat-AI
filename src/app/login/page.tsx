    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[420px] mx-4">
        ...
        <div className="flex items-center justify-center gap-4 mt-4">
          <Link href="/landingpage1" className="text-xs text-white/25 hover:text-indigo-300 transition-colors flex items-center gap-1">
          ...
          <Link href="/landingpage2" className="text-xs text-white/25 hover:text-purple-300 transition-colors flex items-center gap-1">
